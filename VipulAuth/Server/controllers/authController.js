...
export const register = async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      text: `Welcome to VipulStack, ${
        name || "user"
      }! We're glad to have you here. Your account 
    ...
    //   to: email,
    //   subject: "Welcome to VipulStack",
    //   text: `Welcome to VipulStack, ${name || 'user'}! We're glad to have you here.`,
    //   html: `<h1>Welcome to <span style="color:#4CAF50;">VipulStack</span></h1><p>We're excited to have you with us.</p>`
    // };
